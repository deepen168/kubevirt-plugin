...
export declare type ConsoleDetailPropType = {
    address: string;
    port: number | string;
    tlsPort?: number | string;
};
export declare type onGenerateFunctionType = (console: ConsoleDetailPropType, type: string) => {
    content: string;
    mimeType: string;
};
export declare type onDownloadFunctionType = (fileName: string, content: string, mimeType: string) => void;
export declare type ConnectWithRemoteViewerProps = React.HTMLProps<HTMLDivElement> & {
...
export declare type RDPProps = ConnectWithRemoteViewerProps & {
    /** Custom content of more-info section  */
    children?: React.ReactNode;
    isLoading?: boolean;
    /** Connection details for RDP */
...
export declare type ManualConnectionProps = React.HTMLProps<HTMLDivElement> & {
    rdp?: ConsoleDetailPropType;
    spice?: ConsoleDetailPropType;
    textAddress: string;
    textConnectWith: string;
...
export declare type RemoteViewerProps = React.HTMLProps<HTMLDivElement> & {
    /** Custom content of more-info section  */
    children?: React.ReactNode;
    /** Callback function. Perform file download.
     * Default implementation is usually good enough, but i.e. in case of environment with tight
...
export declare type MoreInformationDefaultProps = {
    textMoreInfoContent?: React.ReactNode | string;
};
export declare type DesktopViewerProps = {
    type: string;
    vm: V1VirtualMachine;
    vmi: V1VirtualMachineInstance;
};
export declare type RDPServiceNotConfiguredProps = {
    vm: V1VirtualMachine;
    vmi: V1VirtualMachineInstance;
};
...
export declare type RDPConnectorProps = {
    isLoading: boolean;
    rdpServiceAddressPort: ConsoleDetailPropType;
    vm: V1VirtualMachine;
    vmi: V1VirtualMachineInstance;
};
export declare type MultusNetworkProps = {
