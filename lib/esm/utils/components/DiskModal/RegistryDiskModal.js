...
var RegistryDiskModal = function (_a) {
    ...
    return (React.createElement(FormProvider, __assign({}, methods),
        React.createElement(TabModal, { onSubmit: function () {
            ...
            React.createElement(Form, null,
                ...
                ' ',
                !isCreated && React.createElement(DiskSourceContainer, { fieldName: REGISTRYURL_DATAVOLUME_FIELD, os: os }),
                React.createElement(DiskSizeInput, { isCreated: isCreated, namespace: namespace, pvc: pvc }),
                ...
                !isCreated && React.createElement(StorageClassAndPreallocation, { vm: vm }),
                React.createElement(AdvancedSettings, null)))));
};
export default RegistryDiskModal;
//# sourceMappingURL=RegistryDiskModal.js.map