...
var PVCDiskModal = function (_a) {
    var _b;
    var editDiskName = _a.editDiskName, isCreated = _a.isCreated, isOpen = _a.isOpen, onClose = _a.onClose, onSubmit = _a.onSubmit, pvc = _a.pvc, vm = _a.vm;
    ...
    return (React.createElement(FormProvider, __assign({}, methods),
        React.createElement(TabModal, { onSubmit: function () {
                return handleSubmit(function (data) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                    return [2 /*return*/, submit({ data: data, editDiskName: editDiskName, onSubmit: onSubmit, pvc: pvc, vm: vm })];
                }); }); })();
            ...
            React.createElement(Form, null,
                ...
                React.createElement(DiskSourcePVCSelect, { vmNamepace: (_b = vm === null || vm === void 0 ? void 0 : vm.metadata) === null || _b === void 0 ? void 0 : _b.namespace }),
                isCreated && React.createElement(ExpandPVC, { pvc: pvc }),
...
//# sourceMappingURL=PVCDiskModal.js.map