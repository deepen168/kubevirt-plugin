...
var UploadDiskModal = function (_a) {
    var isOpen = _a.isOpen, onClose = _a.onClose, onSubmit = _a.onSubmit, onUploadedDataVolume = _a.onUploadedDataVolume, vm = _a.vm;
    var _b = useCDIUpload(), upload = _b.upload, uploadData = _b.uploadData;
    ...
    var _c = methods.formState, isSubmitting = _c.isSubmitting, isValid = _c.isValid, handleSubmit = methods.handleSubmit;
    return (React.createElement(FormProvider, __assign({}, methods),
        React.createElement(TabModal, { onClose: function () {
                ...
                return handleSubmit(function (data) { return __awaiter(void 0, void 0, void 0, function () {
                    var uploadedDataVolume, vmWithDisk, newVM;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, uploadDataVolume(vm, uploadData, data)];
                            case 1:
                                uploadedDataVolume = _a.sent();
                                onUploadedDataVolume === null || onUploadedDataVolume === void 0 ? void 0 : onUploadedDataVolume(uploadedDataVolume);
                                ...
                                vmWithDisk = addDisk(data, vm);
                                newVM = reorderBootDisk(vmWithDisk, data.disk.name, data.isBootSource, false);
                                return [2 /*return*/, !isVMRunning ? onSubmit(newVM) : hotplugPromise(newVM, data)];
                        }
                    });
                }); })();
            }, closeOnSubmit: isValid, headerText: diskModalTitle(false, isVMRunning), isLoading: isSubmitting, isOpen: isOpen },
            React.createElement(PendingChanges, { isVMRunning: isVMRunning }),
            React.createElement(Form, null,
                React.createElement(BootSourceCheckbox, { isDisabled: isVMRunning, vm: vm }),
                React.createElement(DiskNameInput, null),
                React.createElement(DiskSourceUploadPVC, { relevantUpload: upload }),
                React.createElement(DiskSizeInput, { namespace: vmNamespace }),
                ...
                React.createElement(StorageClassAndPreallocation, { vm: vm }),
                React.createElement(AdvancedSettings, null)))));
};
export default UploadDiskModal;
//# sourceMappingURL=UploadDiskModal.js.map