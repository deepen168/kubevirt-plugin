...
var OtherDiskModal = function (_a) {
    var createdPVCName = _a.createdPVCName, editDiskName = _a.editDiskName, isCreated = _a.isCreated, isOpen = _a.isOpen, onClose = _a.onClose, onSubmit = _a.onSubmit, vm = _a.vm;
    ...
    return (React.createElement(FormProvider, __assign({}, methods),
        React.createElement(TabModal, { onSubmit: function () {
            ...
            React.createElement(Form, null,
                ...
                doesDataVolumeTemplateHaveDisk(vm, editDiskName) && (React.createElement(StorageClassAndPreallocation, { vm: vm })),
                React.createElement(AdvancedSettings, null)))));
};
export default OtherDiskModal;
//# sourceMappingURL=OtherDiskModal.js.map