...
var StorageIOPSTotalThresholdChart = function (_a) {
    var _b, _c, _d, _e;
    var vmi = _a.vmi;
    ...
    var data = usePrometheusPoll({
        ...
        query: queries === null || queries === void 0 ? void 0 : queries.STORAGE_IOPS_TOTAL,
        timespan: timespan,
    })[0];
    ...
    var linkToMetrics = queriesToLink(queries.STORAGE_IOPS_TOTAL);
    return (React.createElement(ComponentReady, { isReady: !isEmpty(chartData), linkToMetrics: linkToMetrics },
        React.createElement("div", { className: "util-threshold-chart", ref: ref },
            React.createElement(Link, { to: linkToMetrics },
                React.createElement(Chart, { containerComponent: React.createElement(ChartVoronoiContainer, { constrainToVisibleArea: true, labels: function (_a) {
                            var _b;
                            var datum = _a.datum;
                            return t('IOPS total: {{input}}', { input: (_b = datum === null || datum === void 0 ? void 0 : datum.y) === null || _b === void 0 ? void 0 : _b.toFixed(2) });
                        } }), domain: {
                        x: [currentTime - timespan, currentTime],
                        y: [0, yMax],
                    }, height: height, padding: { bottom: 35, left: 80, right: 35, top: 35 }, scale: { x: 'time', y: 'linear' }, width: width },
                    React.createElement(ChartAxis, { style: {
                            grid: {
                                stroke: chart_color_black_200.value,
                            },
                        }, dependentAxis: true, tickFormat: function (tick) { return "".concat(tick === 0 ? tick : tick === null || tick === void 0 ? void 0 : tick.toFixed(2), " IOPS"); }, tickValues: [0, yMax] }),
                    React.createElement(ChartAxis, { style: {
...
//# sourceMappingURL=StorageIOPSTotalThresholdChart.js.map