...
var StorageWriteThresholdChart = function (_a) {
    var _b, _c, _d, _e;
    var vmi = _a.vmi;
    ...
    var data = usePrometheusPoll({
        ...
        query: queries === null || queries === void 0 ? void 0 : queries.FILESYSTEM_WRITE_USAGE,
        timespan: timespan,
    })[0];
    ...
    return (React.createElement(ComponentReady, { isReady: !isEmpty(chartData) },
        React.createElement("div", { className: "util-threshold-chart", ref: ref },
            React.createElement(Chart, { containerComponent: React.createElement(ChartVoronoiContainer, { labels: function (_a) {
                        var datum = _a.datum;
                        return "Data written: ".concat(xbytes(datum === null || datum === void 0 ? void 0 : datum.y, { fixed: 2, iec: true }));
...
//# sourceMappingURL=StorageWriteThresholdChart.js.map