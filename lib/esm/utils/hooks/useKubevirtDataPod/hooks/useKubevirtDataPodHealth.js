...
var useKubevirtDataPodHealth = function () {
    var alive = useRef(null);
    useEffect(function () {
        var fetch = function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, consoleFetch("".concat(PROXY_KUBEVIRT_URL).concat(PROXY_KUBEVIRT_URL_HEALTH_PATH))];
                    case 1:
                        res = _b.sent();
...
//# sourceMappingURL=useKubevirtDataPodHealth.js.map