...
var NetworkInterfaceList = function (_a) {
    ...
    var networkInterfacesData = getNetworkInterfaceRowData(networks, interfaces);
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(VirtualizedTable, { columns: columns, data: filteredData, loaded: true, loadError: false, Row: NetworkInterfaceRow, rowData: { template: template }, unfilteredData: data })));
};
