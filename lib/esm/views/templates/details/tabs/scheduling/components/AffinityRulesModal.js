...
import { getAffinityFromRowsData, getAvailableAffinityID, getRowsDataFromAffinity, } from '@kubevirt-utils/components/AffinityModal/utils/helpers';
...
var AffinityRulesModal = function (_a) {
    var isOpen = _a.isOpen, onClose = _a.onClose, onSubmit = _a.onSubmit, template = _a.template;
    var t = useKubevirtTranslation().t;
    var _b = React.useState(getRowsDataFromAffinity(getAffinity(template))), affinities = _b[0], setAffinities = _b[1];
    ...
    var _f = useK8sWatchResource({
        ...
        isList: true,
    }), nodes = _f[0], nodesLoaded = _f[1];
    var _g = useRequiredAndPrefferedQualifiedNodes(nodes, nodesLoaded, affinities), qualifiedRequiredNodes = _g[0], qualifiedPreferredNodes = _g[1];
