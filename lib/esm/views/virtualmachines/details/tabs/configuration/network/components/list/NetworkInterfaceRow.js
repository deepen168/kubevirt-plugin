...
var NetworkInterfaceRow = function (_a) {
    var _b;
    var activeColumnIDs = _a.activeColumnIDs, _c = _a.obj, iface = _c.iface, network = _c.network, _d = _a.rowData, isPending = _d.isPending, vm = _d.vm;
    var t = useKubevirtTranslation().t;
    return (React.createElement(React.Fragment, null,
        React.createElement(TableData, { activeColumnIDs: activeColumnIDs, id: "name" },
            network.name,
            isPending(network) && React.createElement(PendingBadge, null)),
        ...
        React.createElement(TableData, { activeColumnIDs: activeColumnIDs, className: "dropdown-kebab-pf pf-v5-c-table__action", id: "" },
            React.createElement(NetworkInterfaceActions, { nicName: network.name, nicPresentation: { iface: iface, network: network }, vm: vm }))));
};
