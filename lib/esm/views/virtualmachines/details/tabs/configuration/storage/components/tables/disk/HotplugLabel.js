...
export var HotplugLabel = function (_a) {
    var diskName = _a.diskName, vm = _a.vm, vmi = _a.vmi;
    var t = useKubevirtTranslation().t;
    var hotplugText = React.useMemo(function () {
        var _a, _b, _c, _d, _e;
        ...
        if ((volumeStatus === null || volumeStatus === void 0 ? void 0 : volumeStatus.hotplugVolume) ||
    ...
    return (React.createElement(Label, { color: "purple", variant: "filled" }, hotplugText));
};
//# sourceMappingURL=HotplugLabel.js.map