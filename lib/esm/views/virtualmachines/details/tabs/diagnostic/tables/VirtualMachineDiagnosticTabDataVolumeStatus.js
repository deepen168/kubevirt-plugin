...
var VirtualMachineDiagnosticTabDataVolumeStatus = function (_a) {
    var dataVolumesStatuses = _a.dataVolumesStatuses;
    var t = useKubevirtTranslation().t;
    var _b = useState({
        expended: new Set(),
        ids: new Set(),
    }), expend = _b[0], setExpend = _b[1];
    var _c = useDiagnosticDataVolumeStatusTableColumns(), columns = _c.columns, sorting = _c.sorting;
    var _d = usePagination(), onPaginationChange = _d.onPaginationChange, pagination = _d.pagination;
    var sortedData = useMemo(function () { return columnSorting(dataVolumesStatuses, sorting === null || sorting === void 0 ? void 0 : sorting.direction, pagination, sorting === null || sorting === void 0 ? void 0 : sorting.column); }, [dataVolumesStatuses, sorting, pagination]);
    useEffect(function () {
        return dataVolumesStatuses.forEach(function (_a) {
            var id = _a.id;
    ...
    return (React.createElement(React.Fragment, null,
            ...
            React.createElement(Flex, { justifyContent: { default: 'justifyContentSpaceBetween' } },
                React.createElement(FlexItem, null,
                    React.createElement(Title, { className: "VirtualMachineDiagnosticTab--header", headingLevel: "h2" },
                        t('DataVolume status'),
                        ' ',
                        React.createElement(HelpTextIcon, { bodyContent: t('DataVolume Status is a mechanism for reporting if a volume succeed.'), helpIconClassName: "VirtualMachineDiagnosticTab--HelpTextIcon" }))),
                React.createElement(FlexItem, null,
        ...
        React.createElement(Table, { isExpandable: true },
            ...
            sortedData.map(function (row, index) { return (React.createElement(VirtualMachineDiagnosticTabRow, { activeColumns: columns, expend: expend, index: index, key: row === null || row === void 0 ? void 0 : row.name, obj: row, setExpend: setExpend })); }))));
};
export default VirtualMachineDiagnosticTabDataVolumeStatus;
//# sourceMappingURL=VirtualMachineDiagnosticTabDataVolumeStatus.js.map