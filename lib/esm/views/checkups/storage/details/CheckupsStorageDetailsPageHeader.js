...
var CheckupsStorageDetailsPageHeader = function (_a) {
    var _b;
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Breadcrumb, { className: "pf-c-breadcrumb co-breadcrumb" },
            React.createElement(BreadcrumbItem, null,
                React.createElement(Button, { isInline: true, onClick: function () { return navigate("/k8s/ns/".concat(namespace, "/checkups/storage")); }, variant: ButtonVariant.link }, t('Storage checkup'))),
            React.createElement(BreadcrumbItem, null, t('Storage checkup details'))),
        React.createElement(Flex, { justifyContent: { default: 'justifyContentSpaceBetween' } },
            ...
            React.createElement(FlexItem, null,
                React.createElement(CheckupsStorageActions, { configMap: configMap, jobs: jobs })))));
};
export default CheckupsStorageDetailsPageHeader;
//# sourceMappingURL=CheckupsStorageDetailsPageHeader.js.map