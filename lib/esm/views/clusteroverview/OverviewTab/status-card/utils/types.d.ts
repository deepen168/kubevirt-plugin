...
import { APIServiceDefinition, ClusterServiceVersionIcon, ClusterServiceVersionPhase, CRDDescription, CSVConditionReason, InstallModeType, RequirementStatus } from '../../../utils/types';
...
export declare type VirtStatusItems = {
