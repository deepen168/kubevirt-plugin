...
var CustomizeInstanceTypeYamlTab = function () {
    ...
    var onSave = function (yaml) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            setError(null);
            try {
                updateCustomizeInstanceType([{ data: load(yaml) }]);
            }
            catch (apiError) {
                setError(apiError);
            }
    ...
    return (React.createElement(Suspense, { fallback: React.createElement(Bullseye, null,
            React.createElement(Loading, null)) },
        React.createElement("div", { className: "yaml-body" },
            React.createElement(ResourceYAMLEditor, { initialResource: dump(vm), onSave: onSave })),
        error && (React.createElement("div", { className: "yaml-alert" },
...
//# sourceMappingURL=CustomizeInstanceTypeYamlTab.js.map