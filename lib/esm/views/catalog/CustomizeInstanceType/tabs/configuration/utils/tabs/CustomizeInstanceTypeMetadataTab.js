...
var CustomizeInstanceTypeMetadataTab = function () {
    var _a, _b;
    ...
    var updateMetadata = function (data, type) {
            ...
            React.createElement(DescriptionList, { className: "pf-c-description-list" },
                React.createElement(VirtualMachineDescriptionItem, { bodyContent: t('Map of string keys and values that can be used to organize and categorize (scope and select) objects. May match selectors of replication controllers and services. '), onEditClick: function () {
                        return createModal(function (_a) {
                            ...
                            return (React.createElement(LabelsModal, { isOpen: isOpen, obj: vm, onClose: onClose, onLabelsSubmit: function (labels) { return updateMetadata(labels, 'labels'); } }));
                        });
                    }, breadcrumb: "VirtualMachine.metadata.labels", "data-test-id": "".concat(getName(vm), "-labels"), descriptionData: React.createElement(MetadataTabLabels, { labels: (_a = vm === null || vm === void 0 ? void 0 : vm.metadata) === null || _a === void 0 ? void 0 : _a.labels }), descriptionHeader: React.createElement(SearchItem, { id: "labels" }, t('Labels')), editOnTitleJustify: true, isEdit: true, isPopover: true, moreInfoURL: "http://kubernetes.io/docs/user-guide/labels", showEditOnTitle: true }),
                React.createElement(VirtualMachineDescriptionItem, { bodyContent: t('Annotations is an unstructured key value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. '), onEditClick: function () {
                        return createModal(function (_a) {
                            var isOpen = _a.isOpen, onClose = _a.onClose;
                            return (React.createElement(AnnotationsModal, { isOpen: isOpen, obj: vm, onClose: onClose, onSubmit: function (annotations) { return updateMetadata(annotations, 'annotations'); } }));
                        });
                    }, breadcrumb: "VirtualMachine.metadata.annotations", descriptionData: React.createElement(MetadataTabAnnotations, { annotations: (_b = vm === null || vm === void 0 ? void 0 : vm.metadata) === null || _b === void 0 ? void 0 : _b.annotations }), descriptionHeader: React.createElement(SearchItem, { id: "metadata" }, t('Annotations')), isEdit: true, isPopover: true, moreInfoURL: "http://kubernetes.io/docs/user-guide/annotations" })))));
};
export default CustomizeInstanceTypeMetadataTab;
//# sourceMappingURL=CustomizeInstanceTypeMetadataTab.js.map