...
import { Button, FormGroup, Progress, ProgressMeasureLocation, Stack, StackItem, } from '@patternfly/react-core';
export var SelectSourceUploadPVCProgress = function (_a) {
        ...
        React.createElement(Stack, { hasGutter: true },
            ...
            React.createElement(StackItem, null,
                React.createElement(Button, { isDisabled: (upload === null || upload === void 0 ? void 0 : upload.uploadStatus) === UPLOAD_STATUS.CANCELED ||
                        ...
                        (upload === null || upload === void 0 ? void 0 : upload.uploadStatus) === UPLOAD_STATUS.SUCCESS, isInline: true, onClick: function () { return upload === null || upload === void 0 ? void 0 : upload.cancelUpload(); }, variant: "link" }, t('Cancel upload'))))));
};
//# sourceMappingURL=SelectSourceUploadPVCProgress.js.map