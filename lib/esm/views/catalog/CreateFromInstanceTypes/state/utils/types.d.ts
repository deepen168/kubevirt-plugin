...
import { V1beta1VirtualMachineClusterInstancetype, V1beta1VirtualMachineClusterPreference, V1beta1VirtualMachineInstancetype, V1VirtualMachine } from '@kubevirt-ui/kubevirt-api/kubevirt';
...
export declare type InstanceTypes = (V1beta1VirtualMachineClusterInstancetype | V1beta1VirtualMachineInstancetype)[];
export declare type UseInstanceTypeAndPreferencesValues = {
...
export declare type UseBootableVolumesValues = {
...
export declare type SysprepConfigMapData = {
    data: SysprepData;
    name: string;
    shouldCreateNewConfigMap: boolean;
};
export declare type InstanceTypeVMState = {
...
export declare enum instanceTypeActionType {
...
declare type InstanceTypeAction = {
    payload: {
        name: string;
        namespace: string;
    } | boolean | BootableVolume | SSHSecretDetails | string | SysprepConfigMapData;
    type: string;
};
export declare type InstanceTypeVMStoreState = {
...
declare type InstanceTypeVMStoreActions = {
    applySSHFromSettings: (sshSecretName: string, targetNamespace: string) => void;
    onSelectCreatedVolume: (selectedVolume: BootableVolume, pvcSource: IoK8sApiCoreV1PersistentVolumeClaim, volumeSnapshotSource: VolumeSnapshotKind) => void;
...
export declare type InstanceTypeVMStore = InstanceTypeVMStoreState & InstanceTypeVMStoreActions;
export {};
