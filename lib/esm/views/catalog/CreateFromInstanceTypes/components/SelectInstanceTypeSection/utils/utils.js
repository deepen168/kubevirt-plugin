...
import { InstanceTypeCategory } from './types';
export var categoryDetailsMap = (_a = {},
    _a[InstanceTypeCategory.ComputeIntensive] = {
        Icon: CubesIcon,
        instanceTypes: [
            {
                cpus: 1,
    ...
    _a[InstanceTypeCategory.GeneralPurpose] = {
    ...
    _a[InstanceTypeCategory.GpuResourcesAttached] = {
        Icon: StarIcon,
        instanceTypes: [
            {
                cpus: 4,
    ...
    _a[InstanceTypeCategory.MemoryIntensive] = {
