...
var useClusterInstancetypeActionsProvider = function (instanceType) {
    var t = useKubevirtTranslation().t;
    var createModal = useModal().createModal;
    var _a = useK8sModel(VirtualMachineClusterInstancetypeModelRef), inFlight = _a[1];
    var actions = useMemo(function () {
        return [
            {
                accessReview: asAccessReview(VirtualMachineClusterInstancetypeModel, instanceType, 'create'),
                cta: function () {
                    return createModal(function (modalProps) {
                        return (React.createElement(CloneResourceModal, __assign({}, modalProps, { model: VirtualMachineClusterInstancetypeModel, object: instanceType })));
                    });
                },
                disabled: false,
            ...
            {
                accessReview: asAccessReview(VirtualMachineClusterInstancetypeModel, instanceType, 'delete'),
                cta: function () {
                    return createModal(function (_a) {
                        ...
                        return (React.createElement(DeleteModal, { onDeleteSubmit: function () {
                            ...
                            }, headerText: t('Delete VirtualMachineClusterInstancetype?'), isOpen: isOpen, obj: instanceType, onClose: onClose }));
                    });
                },
                disabled: false,
...
//# sourceMappingURL=useClusterInstancetypeActionsProvider.js.map