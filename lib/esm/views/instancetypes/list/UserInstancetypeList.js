...
var UserInstancetypeList = function (_a) {
    ...
    var _b = useVirtualMachineInstanceTypes(fieldSelector, selector, true), instanceTypes = _b[0], loaded = _b[1], loadError = _b[2];
    ...
    var _f = useUserInstancetypeListColumns(pagination, data), columns = _f[0], activeColumns = _f[1], loadedColumns = _f[2];
    if (loaded && isEmpty(unfilteredData)) {
        return React.createElement(UserInstancetypeEmptyState, { namespace: namespace });
    }
    return (React.createElement(ListPageBody, null,
        ...
        React.createElement(VirtualizedTable, { EmptyMsg: function () { return (React.createElement("div", { className: "pf-u-text-align-center", id: "no-instancetype-msg" }, t('No VirtualMachineInstanceTypes found'))); }, columns: activeColumns, data: data, loaded: loaded && loadedColumns, loadError: loadError, Row: UserInstancetypeRow, unfilteredData: unfilteredData })));
};
export default UserInstancetypeList;
//# sourceMappingURL=UserInstancetypeList.js.map