...
var MigrationPolicyVirtualMachineLabels = function (_a) {
    ...
    var mpVirtualMachineSelector = (_c = (_b = mp === null || mp === void 0 ? void 0 : mp.spec) === null || _b === void 0 ? void 0 : _b.selectors) === null || _c === void 0 ? void 0 : _c.virtualMachineInstanceSelector;
            ...
            React.createElement(Button, { onClick: function () {
                    return createModal(function (_a) {
                        ...
                        return (React.createElement(LabelsModal, { onLabelsSubmit: function (labels) {
                                return k8sUpdate({
                                    data: ensureMigrationPolicyMatchLabels(mp, labels, 'virtualMachineInstanceSelector'),
                                    model: MigrationPolicyModel,
                                });
                            }, initialLabels: mpVirtualMachineSelector, isOpen: isOpen, obj: mp, onClose: onClose }));
                    });
                }, className: "migration-policy-description-item-header--action-button", isInline: true, variant: ButtonVariant.link }, t('Edit'))),
        React.createElement(DescriptionListDescription, null, !isEmpty(mpVirtualMachineSelector) && (React.createElement(LabelGroup, { className: "migration-policy-selectors-group", isEditable: true },
            React.createElement(MigrationPolicySelectorList, { isVMILabel: true, selector: mpVirtualMachineSelector }))))));
};
export default MigrationPolicyVirtualMachineLabels;
//# sourceMappingURL=MigrationPolicyVirtualMachineLabels.js.map